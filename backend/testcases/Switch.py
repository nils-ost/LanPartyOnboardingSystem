...
class TestSwitch(unittest.TestCase):
    ...
    def test_onboarding_vlan_id_purpose_onboarding(self):
        ...
        v.save()
        el = Switch({'addr': 'sw1', 'onboarding_vlan_id': v['_id']})
        result = el.save()
        self.assertIn('onboarding_vlan_id', result['errors'])
        self.assertEqual(len(Switch.all()), 0)
        ...
        v.save()
        el = Switch({'addr': 'sw2', 'onboarding_vlan_id': v['_id']})
        result = el.save()
        self.assertIn('onboarding_vlan_id', result['errors'])
        self.assertEqual(len(Switch.all()), 0)
        ...
        v.save()
        el = Switch({'addr': 'sw3', 'onboarding_vlan_id': v['_id']})
        result = el.save()
        self.assertIn('onboarding_vlan_id', result['errors'])
        self.assertEqual(len(Switch.all()), 0)
        ...
        v.save()
        el = Switch({'addr': 'sw4', 'onboarding_vlan_id': v['_id']})
        result = el.save()
        self.assertNotIn('errors', result)
        self.assertEqual(len(Switch.all()), 1)
    ...
    def test_onboarding_vlan_id_only_used_on_one_switch(self):
        ...
        el = Switch({'addr': 'sw1', 'onboarding_vlan_id': v1['_id']})
        result = el.save()
        self.assertNotIn('errors', result)
        self.assertEqual(len(Switch.all()), 1)
        # assign the vlan to another switch is not ok
        el = Switch({'addr': 'sw2', 'onboarding_vlan_id': v1['_id']})
        result = el.save()
        self.assertIn('onboarding_vlan_id', result['errors'])
        self.assertEqual(len(Switch.all()), 1)
