...
class Setting(SettingBase):
    ...
    _defaults = {
        ...
        'upstream_dns':          {'order': 23, 'type': 'str',   'value': '',          'desc': 'DNS Server that is promoted to the Participants'},
        ...
        'sso_ip_overwrite':      {'order': 33, 'type': 'str',   'value': None,
                                  'desc': 'Option to skip nslookup of SSO-IP and feed haproxy with this value, if value is None nslookup is executed'},
        'play_vlan_def_ip':      {'order': 40, 'type': 'int',   'value': None,        'desc': 'default network IP used for new IpPools in play VLAN'},
        'play_vlan_def_mask':    {'order': 41, 'type': 'int',   'value': 24,          'desc': 'default network mask used for new IpPools in play VLAN'},
        'mgmt_vlan_def_ip':      {'order': 42, 'type': 'int',   'value': None,        'desc': 'default network IP used for new IpPools in mgmt VLAN'},
